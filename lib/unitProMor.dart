...
void addNewUnit(TotalUnit totalunit) {
  final statBox = Hive.box('TotalunitMorning');
...
class UnitProMor extends StatefulWidget {
  const UnitProMor({Key key}) : super(key: key);

  @override
  _UnitProMorState createState() => _UnitProMorState();
}

class _UnitProMorState extends State<UnitProMor> {
  @override
  ...
  Widget _buildListViewUnite() {
    return ValueListenableBuilder(
      valueListenable: Hive.box('TotalunitMorning').listenable(),
      builder: (context, box, widget) {
        return ListView.builder(
          itemCount: Hive.box('TotalunitMorning').length,
          itemBuilder: (context, index) {
            final unit = Hive.box('TotalunitMorning').getAt(index) as TotalUnit;
            return Column(
              children: [
                ListTile(
                  title: Row(
